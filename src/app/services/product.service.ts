...
export class ProductService {
  products = [
    {
      ...
      imagePath: 'product-xx99-mark-ii-headphones',
      isNew: true,
    ...
    },
    {
      ...
      description:
        'TAs the gold standard for headphones, the classic XX99 Mark I offers detailed and accurate audio reproduction for audiophiles, mixing engineers, and music aficionados alike in studios and on the go.',
      imagePath: 'product-xx99-mark-i-headphones',
      isNew: false,
    ...
    },
    {
      ...
      imagePath: 'product-xx59-headphones',
      isNew: false,
    ...
    },
    {
      ...
      imagePath: 'product-yx1-wireless-earphones',
      isNew: true,
      features: `Experience unrivalled stereo sound thanks to innovative acoustic technology. With improved ergonomics designed for full day wearing, these revolutionary earphones have been finely crafted to provide you with the perfect fit, delivering complete comfort all day long while enjoying exceptional noise isolation and truly immersive sound. <br />  <br />
  ...
  getProductsByCategory(category: 'headphones' | 'speakers' | 'earphones') {
  ...
  getInTheBox(category: string) {
    return this.inTheBox.find((items) => items.type === category)?.supplies;
  }
  ...
  addToCart(item: string, quantity: number) {
    const itemInCart = this.cart.findIndex((product) => product.item === item);

    if (itemInCart !== -1) {
      this.cart[itemInCart] = { ...this.cart[itemInCart], quantity };
    } else {
